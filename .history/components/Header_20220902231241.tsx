  ...
  return (
    <header className='sticky top-0 w-full z-30 flex items-center justify-between bg-[#E7ECEE] pt-4'>
      <div className='flex items-center justify-center md:w-1/5'>
        <Link href= "/">
          <div className='relative w-8 h-10 cursor-pointer opacity-75  transition hover:opacity-100'>
            <Image src="1667px-Apple_logo_black.svg.png" layout='fill' objectFit='cover'/>
          </div>
        </Link>
      </div>
