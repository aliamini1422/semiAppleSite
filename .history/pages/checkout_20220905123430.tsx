...
function checkout() {
  ...
  return (
    <div className=' min-h-screen overflow-hidden bg-[#E7ECEE] '>
        <Header />
        <main className='mx-auto max-w-6xl pb-24 flex flex-col items-center '>
            <div className='px-5 '>
                <h1 className='my-8 text-3xl font-semibold lg:text-4xl'>{items.length > 0 ? "Review your bag" : "Your bag is empty."}</h1>
            </div>
